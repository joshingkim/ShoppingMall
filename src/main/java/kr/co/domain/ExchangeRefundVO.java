...
public class ExchangeRefundVO {
	...
	@Override
	public int hashCode() {
		return Objects.hash(exchange_refund_code, exchange_refund_date, exchange_refund_no, member_id, order_no);
	}
	...
	public String toString() {
		return "ExchangeReturnVO [exchange_refund_no=" + exchange_refund_no + ", member_id=" + member_id + ", order_no="
				+ order_no + ", exchange_refund_date=" + exchange_refund_date + ", exchange_refund_code="
